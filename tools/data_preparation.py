...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Data preparation ABAW5 - CVPR 2023')
    parser.add_argument('--root_dir', type=str, default='/home/tu/ABAW3/Dataset/', help='Root data folder')
    parser.add_argument('--out_dir', type=str, default='/home/tu/ABAW3/Dataset/', help='Out data folder')
